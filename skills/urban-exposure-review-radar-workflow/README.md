...
这是本包封装的独立子 skill，来源于 `Imbad0202/academic-research-skills-codex` v0.1.11。它是 `Imbad0202/academic-research-skills` 的 Codex 原生分发版，已保留 manifest、license、upstream README、changelog 和 security 文档。
