# ChatGPT and Cross-Surface Entry Point

Use this directory to connect ChatGPT and Codex to the same versioned research workflow without copying the full repository manual into product instructions.

## Start here

- [Cross-surface contract](cross_surface_contract.md)
